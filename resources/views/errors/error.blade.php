...
<head>
    ...
    <script type="text/javascript">//<![CDATA[
        ...
        function _goToEditorCodeLine(file, line){
            ...
            var local_path = '/Users/josephmontanez/Documents/Comentum/Chores';
            var base_path = '{!! base_path() !!}';
            var file_path = local_path + file.split(base_path)[1];
            xmlhttp.open("GET", "http://localhost:63342/api/file?file=" + encodeURIComponent(file_path) + "&line=" + line, true);
            xmlhttp.send();
        }
        //]]></script>
</head>
