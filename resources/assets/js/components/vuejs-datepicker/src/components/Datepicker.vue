<template>
  <div class="vdp-datepicker" :class="[wrapperClass, isRtl ? 'rtl' : '']">
    <div :class="inputGroupClass">
      <!-- Calendar Button -->
      <div v-show="calendarButton" class="vdp-datepicker__calendar-button" :class="inputGroupAddonClass" @click="showCalendar" v-bind:style="{'cursor:not-allowed;' : disabledPicker}">
          <div class="input-group-text"><i :class="calendarButtonIcon"></i></div>
      </div>
      <!-- Input -->
      <input
        ...
        readonly>
      <!-- Clear Button -->
      <span v-if="clearButton && selectedDate" class="vdp-datepicker__clear-button" :class="{'input-group-addon' : bootstrapStyling || bootstrapStyling4}" @click="clearDate()">
...
export default {
  props: {
    ...
    inputGroupAddonClass: [String, Object],
